...
//取消收藏该文章
function deleteshoppingcart(good_id)
{
	...
	//alert(goodid);
		...
		try{
		    ...
		    xmlHttp.open("GET", "../DeleteGoodLike?good_id=" + good_id, true);
		    xmlHttp.send(null);
		    alert('取消成功!')
		    }catch(exception){
		    alert("取消失败!");
          ...
          <div class="row">
              ...
              *** CUSTOMER MENU ***
              ...
              <div class="card sidebar-menu">
                ...
                <div class="card-body">
                  ...
                  <a href="my_like_good.jsp" class="nav-link active"><i class="fa fa-heart"></i> 我的收藏商品</a>
            ...
            <div id="wishlist" class="col-lg-9">
              ...
              try{
                  ...
                  pager=gld.load_good(user.getId(), pageIndex, pageSize);
                  
                  goods = pager.getDatas();
                  for(GoodLike like:goods)
                  {
                	  Good good=gd.load(like.getGood_id());
                	  %>
                <div class="col-lg-3 col-md-4">
                  <div class="product">
                    <div class="flip-container">
                      <div class="flipper">
                        <div class="front"><a href="../detail2.jsp?article_id=<%=good.getId() %>"><img src="http://localhost:8080/yangyang/img/good/<%=good.getImage() %>" alt="" class="img-fluid"></a></div>
                        <div class="back"><a href="../detail2.jsp?article_id=<%=good.getId() %>"><img src="http://localhost:8080/yangyang/img/good/<%=good.getImage() %>" alt="" class="img-fluid"></a></div>
                      </div>
                    </div><a href="../detail2.jsp?article_id=<%=good.getId() %>" class="invisible"><img src="http://localhost:8080/yangyang/img/good/<%=good.getImage() %>" alt="" class="img-fluid"></a>
                    <div class="text">
                      <h3><a href="../detail2.jsp?article_id=<%=good.getId() %>"><%=good.getName() %></a></h3>
                      <p class="price"> 
                        <del></del>¥<%=good.getPrice() %>
                      </p>
                      <p class="buttons"><a href="../detail2.jsp?article_id=<%=good.getId() %>" class="btn btn-outline-secondary">查看详情</a><a href="javascript:void(0);" onclick="deleteshoppingcart(<%=good.getId() %>);return false;" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>取消收藏</a></p>
                    </div>
                    <!-- /.text-->
                  </div>
                  <!-- /.product            -->
