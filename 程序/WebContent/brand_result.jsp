    ...
    <body>
      ...
      <jsp:include page="header.jsp" />
        <%
           ...
           Brand brand = bd.load(brand_name);
        %>
        <!-- END header -->
                            ...
                            <div class="wrap-thumbnail">
                                <div class="thumbnail">
                                    <div class="thumbnail__news news">
                                        <p class="news__category underscore"><%=brand.getBrand() %>简介</p>
                                        <a href="" class="news__caption"><%=brand.getRemark() %></a>
                                       
                                        <p class="news__desc"><%=brand.getContent() %></p>
        ...
        <section>
            ...
            <div class="wrap wrap_white">
                <div class="container title">
                    <h1 class="title__h1 underscore">热门·商品</h1>
                </div>
            </div>
            <!-- END title -->
            <div class="wrap wrap_gray pt20">
                <div class="container">
                    ...
                    <%
                                       ...
                                       List<Article> articles=ad.loadBrand(brand_name);
                                       GoodDao gd=new GoodDao();
                                       List<Good> goods=gd.loadBrand(brand_name);
                                       for (Good good:goods)
                                       {
                         ...
                         <div class="col-sm-3" style="height:360px">
                            <div class="thumbnail thumbnail_small">
                                <a href="detail2.jsp?article_id=<%=good.getId() %>" class="thumbnail__link">
                                    <img src="http://localhost:8080/yangyang/img/good/<%=good.getImage() %>" style="height:170px;weight:24%;float:left"  alt="News">
                                </a>
                                <div class="caption thumbnail__caption">
                                    <div class="news caption__news">
                                        <i class="icon-play"></i>
                                        <p class="news__category yellow-line"><%=brand_name %></p>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="row">
                            <div class="block-title col-sm-12">
                                <h2 class="block-title__h2">相关文章
                                <a class="block-title__view-all" href="shequ/search_article.jsp?article_name=<%=brand_name %>" data-hover="See all">查看更多</a>
                            </h2>
                            </div>
                            <%
                            ...
                            <div class="col-sm-4" style="height:400px">
                                <div class="thumbnail thumbnail_small" style="width:270px;height:370px">
                                    <a href="detail.jsp?article_id=<%=article.getId() %>" class="thumbnail__link">
                                        <img src="http://localhost:8080/yangyang/img/article/<%=images[0] %>" height="153" width="260" alt="News">
                                    </a>
                                    <div class="caption thumbnail__caption">
                                        <div class="news caption__news">
                    ...
                    <div class="col-sm-3">
                        ...
                        <%
                           ...
                           {
                        	   if(top1.getBrand().equals(brand_name))
                        	   {
                        %>
                            <div class="redaction redaction_line">
                                <p class="redaction__category yel_line"><%=top1.getBrand() %></p>
                                <a class="redaction__title">品牌排名:<%=paiming %></a>
                                <p class="redaction__text">用户收藏该品牌商品数:<%=top1.getFocus_good_number() %></p>
