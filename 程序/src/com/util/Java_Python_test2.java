...
public class Java_Python_test2 {
    public String best_fit(int user_id) {
    	...
    	String like_id="";
    	try {
    	    String[] args = new String[] { "python", "E:\\eclipse-workspace\\yangyang\\src\\com\\python\\tuijian_article.py", String.valueOf(user_id) };
...
//    	}
    	Java_Python_test2 j=new Java_Python_test2();
    	j.UpdateData("回力");
    }
}
